      ...
      >
        <div className="flex w-full gap-2 relative">
          <select
            ...
            className="flex h-11 w-28 rounded-custom-md border border-border bg-surface px-2.5 text-sm text-foreground shadow-soft transition-all focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20 disabled:cursor-not-allowed disabled:bg-muted/5 cursor-pointer font-semibold"
          >
            {countryList.map((c) => (
